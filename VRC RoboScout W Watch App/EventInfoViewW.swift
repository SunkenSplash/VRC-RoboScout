...
struct EventInfoViewW: View {
    ...
    var body: some View {
        VStack {
            List {
                Text(event.name).multilineTextAlignment(.center).padding().listRowBackground(EmptyView())
                HStack {
                    Text("Teams")
                    Spacer()
